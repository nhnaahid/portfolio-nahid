...
const About = () => {
    return (
        <div className='p-5 font-mont text-black space-y-5'>
            ...
            <div className='grid grid-cols-3 grid-rows-1 gap-3 justify-between items-center'>
                {/* education */}
                <div className='border p-3 space-y-5 h-full'>
