...
const Contact = () => {
    return (
        <div className='p-2 md:p-5 font-mont text-black flex flex-col md:flex-row gap-2 items-start justify-between'>
            {/* contact me */}
            ...
            <div className="w-full md:w-1/2 lg:w-3/5 h-full bg-base-200 p-3 lg:p-5 rounded-xl">
                <form className="grid space-y-2" >
                    <input type="text" placeholder="Your Name" className="input input-sm lg:input-md input-bordered w-full" />

                    <input type="email" placeholder="Your Email" className="input input-sm lg:input-md input-bordered w-full" />
